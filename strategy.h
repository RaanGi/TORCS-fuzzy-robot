...
class AbstractStrategy {
	public:
		...
		virtual bool needPitstop(tCarElt* car, tSituation *s, FuzzyControl *fc) = 0;
...
class SimpleStrategy : public AbstractStrategy {
	public:
		...
		bool needPitstop(tCarElt* car, tSituation *s, FuzzyControl *fc);
